  ...
  return (
    <div className={cn(
      "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
      {
        ...
        "border-transparent bg-eco-500 text-white hover:bg-eco-500/80": variant === "success",
        "border-transparent bg-alert-500 text-black hover:bg-alert-500/80": variant === "warning",
      },
      className
    )} {...props} />
  );
